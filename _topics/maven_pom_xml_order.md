...
## (7) `description` (Not used in CMPSC 56)
...
For the syntax, and more info, see: <https://maven.apache.org/pom.html#Reporting>
...
The only advantage of using this field over, say, an XML
comment in the `pom.xml` file might be that it could be used by some
downstream documentation generator.
