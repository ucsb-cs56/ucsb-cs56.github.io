...
* Link to full example of RationalTest.java: <https://github.com/UCSB-CS56-pconrad/cs56-rational-ex03/blob/master/RationalTest.java>
...
In the next tutorial, [Rational: ex04](/tutorials/rational_ex04/), we'll:
